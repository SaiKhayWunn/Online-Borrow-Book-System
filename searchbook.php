...
<div class=" white-text table-responsive container">
  <h4 class="text-light"> Search Result </h4> <br>
...
$select ="SELECT * FROM BookName,author,catorigies WHERE BookName.authorID=author.authorID AND catorigies.CatorigiesID=BookName.CatorigiesID AND BookName.Tittle LIKE '%$n%' ";
