...
<br>
<main class="pt-5 mx-lg-5 view "style="background-image: url('img/15255.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
  <br>
<!--Modal: modalPush-->
 ...
 <table id="dtBasicExample" class="table table-striped table-bordered white-text " cellspacing="0" style="width: 100%;">
  <thead>
    <tr>
      ...
      <th class="th-sm">Manage Quantity
      </th>
    </tr>
  </thead>
  <?php 
