...
<br>
<main class="pt-5 mx-lg-5 view "style="background-image: url('img/unname2d.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
  <br><br>
<!--Modal: modalPush-->
<div class=" white-text table-responsive container">
  <h4 class="text-light"> Most Borrowed Book List </h4> <br>
 ...
 <table id="dtBasicExample" class="table table-striped table-bordered white-text" cellspacing="0" style="width: 100%;">
  <thead>
    <tr>
      ...
      <th class="th-sm">Instock Quantity
      </th>
...
$select ="SELECT COUNT(bd.bookID) as tt,BookName.*,author.*,catorigies.* FROM BookName,author,catorigies,borrow b,borrowdetail bd WHERE BookName.authorID=author.authorID AND catorigies.CatorigiesID=BookName.CatorigiesID AND b.borrowID=bd.borrowID AND bd.bookID=BookName.bookID GROUP BY bd.bookID order by tt desc LIMIT 5";
