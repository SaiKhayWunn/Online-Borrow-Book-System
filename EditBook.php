...
<body class="elegant-color-dark">
  ...
  if(isset($_GET['bid']))
    ...
    $selb=mysqli_query($con,"SELECT * FROM bookname WHERE bookID=$bid");
    $b=mysqli_fetch_assoc($selb);
    ?>
    <!-- Navbar -->
  ...
  <!--Main Navigation-->
<main class="pt-5 mx-lg-5 view "style="background-image: url('../Customer2/img/book-stack.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
<br><br>
    ...
    <form action="AdminCodes.php" method="post" enctype="multipart/form-data">
      ...
      <select class="form-control" name="authorname">
        <?php  
              ...
              {
                if($b['authorID']==$record['authorID'])
                {
            ?>
        <option value="<?php echo $record['authorID'];?>" selected>
     ...
     <select class="form-control" name="CatorigiesName">
        <?php  
              ...
              {
                if($b['CatorigiesID']==$record['CatorigiesID']){
            ?>
        <option value="<?php echo $record['CatorigiesID'];?>" selected>
      ...
      <?php }} ?>
          ...
          <br>
      <input type="text" class="form-control" name="tittle" value="<?php echo $b['Tittle']; ?>" >
              
     <br>
      <input type="text" class="form-control validate" name="descri" value="<?php echo $b['bookDescription']; ?>">

      <br>
      <input type="number" class="form-control validate" name="prices" value="<?php echo $b['prices']; ?>" min="1">

      <br>    
      <input type="number" class="form-control validate" name="qty" value="<?php echo $b['qty']; ?>" min="1">
      <br>
  ...
  <br>
    <br>
      <div class=" d-flex justify-content-center buttonAddFormWrapper">
            <button class="btn btn-outline-primary btn-block buttonAdd" type="submit" name="bookEdit" value="add" name="add">Edit
