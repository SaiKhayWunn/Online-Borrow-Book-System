...
<br>
  <h4 class="text-light"> Cancel List </h4> <br>
...
WHERE b.borrowID=bd.borrowID AND b.borrowID=d.borrowID AND bn.bookID=bd.bookID AND b.memberID=m.memberID AND b.status=0 GROUP BY bd.borrowID ORDER BY b.borrowID DESC";
